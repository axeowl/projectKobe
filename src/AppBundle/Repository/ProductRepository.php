...
class ProductRepository extends EntityRepository
{
    ...
    public function getAllProduct($id)
    {
        ...
        $sql = "SELECT DISTINCT * from product, user, user_has_product WHERE user_has_product.user_iduser = user.iduser AND user_has_product.product_idproduct = product.idproduct AND user.iduser = $id";
